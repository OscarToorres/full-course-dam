...
public class DiseñoColores extends JFrame {
    ...
    //¡¡¡OJO!!!
    //Tener en cuenta que las variables hay que declararlas privadas y trabajar fuera con getters y setters
    ...
    //Barras de scroll
    JScrollBar[] barra = new JScrollBar[3];

    //Etiquetas
    JLabel rgbRojo = new JLabel("rojo");
    JLabel rgbVerde = new JLabel("verde");
    JLabel rgbAzul = new JLabel("azul");

    //Cajas de texto 
    private JTextField[] rgbNumero = new JTextField[3];
    
    //Array de Botones de colores
    JButton [] colores = new JButton[13];

    //Array de String con los colores por defecto
    String[] color = {"negro", "gris oscuro", "gris","grisClaro", "blanco",
    ...
    public DiseñoColores() { 
        ...
        //Botones
        //Primero se crea un botos y despues se asigna al Array, esto se hace para evitar posibles fallos e incongruencias
        ...
        for(int i = 0; i < barra.length; i++){
            ...
            //empieza, extent es la longitud de la barra desplazadora min valor minimo, max valor maximmo
