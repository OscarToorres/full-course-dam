...
public class VentanaBorderControlador implements ActionListener {

    VentanaBorderLayout miVentana;

    public VentanaBorderControlador(){
        miVentana = new VentanaBorderLayout();
    }

    public VentanaBorderControlador(VentanaBorderLayout miVentana){
